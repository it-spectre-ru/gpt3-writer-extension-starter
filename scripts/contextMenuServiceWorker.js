...
const generateCompletionAction = async (info, tab) => {
  try {
    ...
    const basePromptPrefix = 'Help me write lyrics in the style of Drake, Canadian Rapper\n';
    ...
    // Final prompt
    const finalChoice = await generate(`${finalPromptPrefix}${selectionText}${baseChoice.text}`);
